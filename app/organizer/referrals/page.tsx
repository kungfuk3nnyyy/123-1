...
export default function OrganizerReferralsPage() {
  ...
  const shareOnSocial = (platform: string) => {
    ...
    const referralLink = `${window.location.origin}/auth/signup?ref=${stats.referralCode}`
    const message = `Join GigSecure using my referral link and get KES 500 credit to book amazing talent! ${referralLink}`
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-muted-foreground">
          Earn KES 1,000 for each friend who joins GigSecure and makes their first booking payment!
        </p>
      </motion.div>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              Share this link and earn KES 1,000 when your friends sign up and make their first booking payment!
            </p>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex flex-col items-center text-center p-4 rounded-lg bg-green-50">
                ...
                <p className="text-sm text-muted-foreground">
                  They sign up using your link and receive KES 500 credit for bookings
                </p>
              </div>
              <div className="flex flex-col items-center text-center p-4 rounded-lg bg-yellow-50">
                ...
                <p className="text-sm text-muted-foreground">
                  When they make their first booking payment, you earn KES 1,000!
                </p>
              </div>
            </div>
          </CardContent>
